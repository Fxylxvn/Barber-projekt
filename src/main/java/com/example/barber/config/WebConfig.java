 ...
 * bez konieczności umieszczania ich w {@code src/main/resources/static}.</p>
 */
@Configuration
public class WebConfig implements WebMvcConfigurer {
     ...
     * przez pliki z katalogu {@code <katalog_roboczy>/uploads/} na dysku.</p>
     *
     * @param registry rejestr handlerów zasobów dostarczany przez Spring MVC
     */
    @Override

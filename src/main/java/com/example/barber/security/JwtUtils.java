...
public class JwtUtils {
     ...
     * <p>Token zawiera:
     * <ul>
     *   <li><b>subject</b> – nazwa użytkownika (login).</li>
     *   <li><b>claim "roles"</b> – lista ról użytkownika, np. {@code ["ROLE_BARBER"]}.</li>
     *   <li><b>issuedAt</b> – czas wystawienia tokenu.</li>
     *   <li><b>expiration</b> – czas wygaśnięcia (teraz + {@code jwtExpirationMs}).</li>
     *   <li><b>podpis HMAC-SHA256</b> – zabezpieczenie przed fałszowaniem.</li>
     * </ul>
     * </p>
     *
     * @param authentication obiekt Spring Security zawierający dane zalogowanego użytkownika
     * @return podpisany token JWT jako string (format: header.payload.signature)
     */
